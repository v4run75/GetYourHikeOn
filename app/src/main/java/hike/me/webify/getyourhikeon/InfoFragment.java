...
//        });
    ...
    private void prepareListData() {
        ...
        aboutus.add("Get your hike on is a venture aiming to help users book amazing treks and explore the mother nature and create wonderful memories");

        List<String> terms = new ArrayList<String>();
        terms.add("This Terms of Use Agreement (“Agreement”) constitutes a legally binding agreement made between you, whether personally or on behalf of an entity (“user” or “you”) and GET YOUR HIKE ON and its affiliated companies (collectively, “Company” or “we” or “us” or “our”), concerning your access to and use of the __________ website as well as any other media form, media channel, mobile website or mobile application related or connected thereto (collectively, the “Website”). The Website provides the following service: SHOWING HIKING SPOTS AROUND THE WORLD (“Company Services”). Supplemental terms and conditions or documents that may be posted on the Website from time to time, are hereby expressly incorporated into this Agreement by reference.\n" +
                "\n" +
        ...
        privacy.add("PRIVACY POLICY\n" +
                ...
                "TJS ENTERPRIZES (“Company”)\n" +
                "17412 NORTH 79TH STREET\n" +
                "SCOTTSDALE , AZ 85255\n" +
                "Email: TCAMELBACK@MSN.COM\n" +
                "Phone: (602) 430-5789\n" +
                " \n" +
                ...
                " \n" +
                "Users are allowed on GETYOURHIKEON.COM to transmit and receive valid electronic signatures in the United States under the Electronic Signatures in Global and National Commerce Act (E-Sign Act) of 2000 and the Uniform Electronic Transactions Act (UETA) of 1999 as adopted by individual states. Users’ signatures and identities are not authenticated on GETYOURHIKEON.COM.\n" +
                "  \n" +
                "MISCELLANEOUS\n" +
                " \n" +
